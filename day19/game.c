            ...
            case 10 :           // 플레이
                {
                    ...
                    static SDL_bool door_Switch = SDL_FALSE;
                    static SDL_bool timer_Switch = SDL_FALSE;
                    ...
                    if (door_Time_End - door_Time_Start; > 3) {
                    ...
                    //충돌처리
                    Sint16 _attr = g_AttrLayer[g_PlayerPos.x + (g_PlayerPos.y*15)];
                    ...
                    //속성 처리
                    {
                        g_ObjLayer[g_PlayerPos.y * 15 + g_PlayerPos.x] =1;
                    }
                }
                break;
            case 11 :   //next
